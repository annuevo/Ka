...
function showDedicationText() { //seguidores
  ...
  if (!text) {
    text = `Para el amor de mi vida Katia:\n\nKatia me encanta cada momento contigo. Tu sonrisa, tu fuerza, tu forma de ser… todo en ti me hace sentir bien, hasta esas competencias de fuerza que tenemos donde finjo que puedes ganarme pero la verdad es que tu ya me ganaste... mi corazon .\n\nEres hermosa y cada dia contigo me hace mas feliz, te quiero mucho.\n\nTe amo más de lo que las palabras pueden expresar.`;  } else {
...
function showSignature() {
  ...
  signature.textContent = firma ? decodeURIComponent(firma) : "Con amor, Jhon";
...
function showCountdown() {
  ...
  let eventDate = eventParam ? new Date(eventParam + 'T00:00:00') : new Date('2026-06-13T00:00:00');
...
let eventSeconds = Math.max(0, Math.floor((eventDiff / 1000) % 60));
    ...
    container.innerHTML =
      `Llevamos juntos: <b>${days} + 1</b> días<br>` +
